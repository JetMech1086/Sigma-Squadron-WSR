...
const startDate = '2022-07-29';
const endDate = '2022-08-07';
const submissionDate = '2022-08-22';
...
const ACTIVITY = {
  ...
  55962: {
    ...
    notes: 'Have not got a chance to do much flying, been busy getting all the behind the scenes stuff ready. Hope to get some in this week.',
  },
  // Ayre
  56266: {
    ...
    flightActivity: 'BF2',
    otherActivity: '',
    notes: 'Great job gettig some games in with JetMech',
  },
  // Flax Rogers
  56344: {
    communication: 'Discord',
  ...
  55761: {
    ...
    otherActivity: '',
    notes: 'You are killing it already as SQXO, Keep up the great work!',
  },
  ...
  55758: {
    ...
    otherActivity: 'Signal Scramble Infection',
    notes: 'You are looking like a TC battle machine. Is that a high score I see!',
  },

  // Mark Schueler
  4182: {
    communication: 'Discord',
    flightActivity: 'TC Battles',
    otherActivity: '',
    notes: 'Glad to have you as part of Sigma General. Already doing great work in battles.',
  },
};
